                            ...
                            <div class="info-footer">
                                ...
                                <ul class="info-contact">
                                    <li>
                                        ...
                                        <span class="info">Phone: +62 812 3104 3434</span>
                                    </li>
                                    <li>
                                        <span class="lnr lnr-envelope info-icon"></span>
                                        <span class="info">lenterastudios@gmail.com</span>
                                    </li>
                                    <li>
                                        <span class="lnr lnr-map-marker info-icon"></span>
                                        <span class="info">6th floor Library Building, ITS, Surabaya</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="copyright-text">
                                <p>&copy; 2019
                                    <a href="#">Trofhee</a>. All rights reserved. Made with Love by
                                    <a href="#">Lentera Studios</a>
                                </p>
                            </div>
